...
export default function HomeFilterSidebar({
  ...
  return (
    ...
    >
      ...
      {/* ── Sahibinden-style Breadcrumbs ── */}
      <div className="px-5 py-2 text-[10px] text-text-muted border-b border-border-standard/40 flex items-center gap-1.5 bg-surface-container-low/20">
